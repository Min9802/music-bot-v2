...
module.exports = {
  ...
  [✨ Support Server](${
  ...
  }) | [GitHub](https://github.com/Min9802/Discord-MusicBot) | By [Min](https://www.facebook.com/Min9802/)`);
    if (!args[0]) message.channel.send(Embed);
      ...
      if (!cmd)
        return client.sendTime(message.channel, `❌ | Lệnh sai kìa thằng ngu.`);
  ...
  [✨ Support Server](${
    client.botconfig.SupportServer
      ...
      if (!args) return interaction.send(Embed);
        ...
        if (!cmd)
          return client.sendTime(interaction, `❌ | Lệnh sai kìa thằng ngu.`);
