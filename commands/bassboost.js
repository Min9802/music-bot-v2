...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        return client.sendTime(message.channel, `✅ | **Tao set Bassboost level** \`${level}\``);
    },
    SlashCommand: {
        options: [
            {
                name: "level",
                description: `Chọn level bass đi tml. Đây nè Levels: low, medium, high, or none`,
                value: "[level]",
                type: 3,
                required: true,
            },
        ...
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if (guild.me.voice.channel && !guild.me.voice.channel.equals(voiceChannel)) return client.sendTime(interaction, ":x: | **Vào cùng room voice của tao mới được dùng lệnh!!**");
            ...
            return client.sendTime(interaction, `✅ | **Tao set bassboost level** \`${level}\``);
        },
    },
};
