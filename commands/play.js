...
module.exports = {
    name: "play",
    description: "Mở bài hát mày thích",
    usage: "[song]",
    permissions: {
        ...
        try {
            if (SearchString.match(client.Lavasfy.spotifyPattern)) {
                ...
                if (Searched.loadType === "PLAYLIST_LOADED") {
                    ...
                    SongAddedEmbed.setAuthor(`Danh sách phát đã được thêm vào hàng chờ`, message.author.displayAvatarURL());
                    SongAddedEmbed.addField("Enqueued", `\`${Searched.tracks.length}\` songs`, false);
                    //SongAddedEmbed.addField("Thời lượng danh sách phát", `\`${prettyMilliseconds(Searched.tracks, { colonNotation: true })}\``, false)
                ...
                if (Searched.loadType === "NO_MATCHES") return client.sendTime(message.channel, "**Không tìm được - **" + SearchString);
                    ...
                    if (!player.playing && !player.paused && player.queue.totalSize === Searched.tracks.length) player.play();
                    SongAddedEmbed.setAuthor(`Danh sách phát đã được thêm vào hàng chờ`, client.botconfig.IconURL);
        ...
        options: [
            {
                ...
                type: 3,
                required: true,
                description: "Phát nhạc trong room voice",
            },
        ],
        /**
         *
            ...
            if (search.match(client.Lavasfy.spotifyPattern)) {
                ...
                switch (Searched.loadType) {
                    ...
                    case "SEARCH_RESULT":
                        ...
                        let SongAdded = new MessageEmbed();
                            SongAdded.setAuthor(`Thêm vào hàng chờ`, client.botconfig.IconURL);
                            ...
                            if (player.queue.totalSize > 1) SongAdded.addField("Vị trí trong hàng chờ", `${player.queue.size - 0}`, true);
                    ...
                    case "PLAYLIST_LOADED":
                        ...
                        Playlist.setAuthor(`Danh sách phát đã được thêm vào hàng chờ`, client.botconfig.IconURL);
                ...
                switch (res.loadType) {
                    ...
                    case "PLAYLIST_LOADED":
                        ...
                        await player.play();
                        let SongAdded = new MessageEmbed();
                        SongAdded.setAuthor(`Danh sách phát đã được thêm vào hàng chờ`, client.botconfig.IconURL);
